...
from patrick.utils.database import get_authuser_names, get_cmode
from patrick.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from patrick.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await patrick.stop_stream(message.chat.id)
    except:
        pass
