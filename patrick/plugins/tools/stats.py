...
from patrick.core.userbot import assistants
from patrick.misc import SUDOERS, pymongodb
from patrick.plugins import ALL_MODULES
from patrick.utils.database import (get_global_tops,
                                       get_particulars, get_queries,
                                       get_served_chats,
                                       get_served_users, get_sudoers,
                                       get_top_chats, get_topp_users)
from patrick.utils.decorators.language import language, languageCB
from patrick.utils.inline.stats import (back_stats_buttons,
                                           back_stats_markup,
                                           get_stats_markup,
