...
from patrick.utils import first_page, second_page
from patrick.utils.database import get_lang, is_commanddelete_on
from patrick.utils.decorators.language import (LanguageStart,
                                                  languageCB)
from patrick.utils.inline.help import (help_back_markup,
                                          private_help_panel)
...
@app.on_callback_query(filters.regex("patrickSecpg") & ~BANNED_USERS)
@languageCB
